...
export default function CampaignsListPage() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // If course rep, fetch their parent lecturer
      ...
      // Query campaigns based on role
      let query = supabase.from('campaigns').select('*, host:host_id(full_name)')
      if (profile.role === 'course_rep') {
        // Display both campaigns managed by them and general campaigns in school
      ...
      // Calculate stats based on payment sessions
